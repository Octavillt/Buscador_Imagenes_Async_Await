...
// Esta función asíncrona se encargará de buscar imágenes en una API (en este caso, Pixabay)
async function buscarImagenes() {
    ...
    // Usamos try catch para el control de errores y await fetch para hacer una petición a la URL y obtener las imágenes
    try {
        ...
        // Mensaje de error en consola en caso de que haya algún error
        console.log(error)
    }
}
